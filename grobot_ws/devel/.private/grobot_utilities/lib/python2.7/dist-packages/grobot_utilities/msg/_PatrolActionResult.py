...
"""autogenerated by genpy from grobot_utilities/PatrolActionResult.msg. Do not edit."""
import sys
...
class PatrolActionResult(genpy.Message):
  ...
  _type = "grobot_utilities/PatrolActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','grobot_utilities/PatrolResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = grobot_utilities.msg.PatrolResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = grobot_utilities.msg.PatrolResult()
